...
let viewgird = [{
  ...
  },
  {
    ...
    path: '/SC_ProjectInfo',
    name: 'SC_ProjectInfo',
    component: () => import('@/views/sc/sc/SC_ProjectInfo.vue')
  }, {
    path: '/sc/sc/SC_ProjectInfoDetail',
    name: 'SC_ProjectInfoDetail',
    component: () => import('@/views/sc/sc/SC_ProjectInfoDetail.vue')
  }, {
    path: '/SC_ConTractings',
    name: 'SC_ConTractings',
    component: () => import('@/views/sc/sc/SC_ConTractings.vue')
  }, {
    path: '/SC_TeamManagement',
    name: 'SC_TeamManagement',
    component: () => import('@/views/sc/sc/SC_TeamManagement.vue')
  }, {
    path: '/SC_WorkerBaseInfo',
    name: 'SC_WorkerBaseInfo',
    component: () => import('@/views/sc/sc/SC_WorkerBaseInfo.vue')
  }, {
    path: '/SC_WorkerAttendance',
    name: 'SC_WorkerAttendance',
    component: () => import('@/views/sc/sc/SC_WorkerAttendance.vue')
  }
]
