...
namespace VOL.Entity.DomainModels
{
    ...
    public partial class MES_ProductInbound:BaseEntity
    {
       ...
       /// <summary>
       /// 入库物料的编号 (外键, 关联MES_Material.MaterialCode)
       /// </summary>
       [Display(Name ="物料编号")]
       [MaxLength(100)]
       [Column(TypeName="nvarchar(100)")]
       ...
       /// <summary>
       /// 物料入库的目标货位ID (外键, 关联MES_LocationManagement.LocationID)
       /// </summary>
       [Display(Name ="货位ID")]
       [MaxLength(36)]
       [Column(TypeName="uniqueidentifier")]
       ...
       /// <summary>
       /// 本次入库的原因 (例如: 采购入库, 生产入库, 退货入库等，具体值参照业务定义)
       /// </summary>
       [Display(Name ="入库原因")]
       [MaxLength(100)]
       [Column(TypeName="nvarchar(100)")]
